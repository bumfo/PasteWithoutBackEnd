...
(function() {
  var LZMA = (function () {
      ...
      function $read_0(this$static, buf, off, len) {
          ...
          if (arraycopy(this$static.buf, this$static.pos, buf, off, len) !== buf) {
            throw new Error('buf changed');
          }
          this$static.pos += len;
          return len;
      }
      ...
      function $ByteArrayOutputStream(this$static) {
          this$static.buf = initDimUint8(32);
          this$static.count = 0;
          return this$static;
      }
      ...
      function $toByteArray(this$static) {
          ...
          if (data instanceof Uint8Array) {
            data = new Uint8Array(this$static.count);
            var old = this$static.buf;
            var n = this$static.count;
            for (var i = 0; i < n; ++i) {
              data[i] = old[i];
            }
          } else {
      ...
      function $write(this$static, b) {
          if (this$static.buf instanceof Uint8Array) {
            if (this$static.count == this$static.buf.length) {
              var old = this$static.buf;

              this$static.buf = new Uint8Array(old.length << 1);
              this$static.buf.set(old);
            }
          }
      ...
      function $write_0(this$static, buf, off, len) {
          this$static.buf = arraycopy(buf, off, this$static.buf, this$static.count, len);
      ...
      function arraycopy(src, srcOfs, dest, destOfs, len) {
          if (dest instanceof Uint8Array) {
            if (destOfs + len > dest.length) {
              var old = dest;
              dest = new Uint8Array(destOfs + len);
              dest.set(old);
            }
          }
...
// this.LZMA = this.LZMA_WORKER = LZMA;
  ...
  this['lzma_compress'] = function(s) {
    return new Promise((done, reject) => {
      LZMA.compress(s, 9, (res, err) => {
        if (res !== null) {
  ...
  this['lzma_decompress'] = function(a) {
    return new Promise((done, reject) => {
      LZMA.decompress(a, (res, err) => {
        if (res !== null) {
          done(res);
        } else {
          reject(err);
